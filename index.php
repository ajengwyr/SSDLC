...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">MiWallet</a>
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to Mi - Wallet</h1>
            <p class="lead" style="font-size: 16pt;">Aplikasi pencatatan keuangan harian dengan
                fitur
                transaksi terbaik</p>
            <a href="login" class="btn btn-outline-light button">Gabung</a>
        </div>
    </header>
    <!-- header -->
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">Mi - Wallet</h4>
                <p class="isi-fitur text-center">Mi - Wallet adalah aplikasi web pencatatan keuangan harian yang
                    mempunyai fitur-fitur terbaik untuk memonitoring keuangan harian anda. Direkomendasikan bagi para
                    remaja
        ...
        <div class="container text-light">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>About</b> </h5>
                    <p class="mb-0">Aplikasi Mi-Wallet dilengkapi dengan fitur menarik yang dapat mempermudah user mengelola keuangannya.</p>
                </div>
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>Follow us</b> </h5>
                    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0 mt-2">Copyright © 2022 Wiyar Wilujengning Sejati</p> 
                </div>
            </div>
        </div>
    </div>
